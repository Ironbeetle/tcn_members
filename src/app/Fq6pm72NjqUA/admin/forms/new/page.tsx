...
/**
 * Admin - Create New Sign-up Form Page
 * 
...
import { ArrowLeft, Plus, Trash2, GripVertical, Save, Eye, Type, Hash, Mail, Phone, Calendar, List, CheckSquare, AlignLeft, UserPlus } from 'lucide-react'
...
export default function AdminNewFormPage() {
  ...
  const renderFieldPreview = (field: BuilderField) => {
    switch (field.type) {
      ...
      case 'DATE':
        return (
          <input type="date" disabled className="staff-input w-full px-4 py-2 rounded-lg opacity-70" />
        )
      case 'SELECT':
        return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="staff-card rounded-xl p-6 space-y-4">
            <h2 className="text-white font-medium">Form Details</h2>
          ...
          <div className="staff-card rounded-xl p-6 space-y-4">
            ...
            {fields.length === 0 ? (
              ...
              <div className="space-y-3">
                {fields.map((field) => (
                  <div key={field.id} className="staff-card rounded-lg p-4 border-white/10">
                    {preview ? (
                      <div>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center gap-3">
                          <GripVertical className="w-4 h-4 text-staff-muted cursor-move" />
                          <div className="flex-1 flex items-center gap-3">
                            <span className="text-xs text-staff-muted uppercase">{field.type}</span>
                            <input
                              type="text"
                              value={field.label}
