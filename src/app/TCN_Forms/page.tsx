...
// Category display info - mapped to FormCategory enum values from Prisma
const categoryInfo: Record<string, { label: string; color: string; bgColor: string; icon: React.ReactNode }> = {
  // Main department categories
  BAND_OFFICE: { label: 'Band Office', color: 'text-blue-700', bgColor: 'bg-blue-100', icon: <FolderOpen className="w-4 h-4" /> },
  TCN_HEALTH: { label: 'Health', color: 'text-green-700', bgColor: 'bg-green-100', icon: <ClipboardCheck className="w-4 h-4" /> },
  EDUCATION_AUTHORITY: { label: 'Education', color: 'text-purple-700', bgColor: 'bg-purple-100', icon: <FileText className="w-4 h-4" /> },
  ADULT_ED: { label: 'Adult Education', color: 'text-purple-600', bgColor: 'bg-purple-50', icon: <FileText className="w-4 h-4" /> },
  HOUSING: { label: 'Housing', color: 'text-orange-700', bgColor: 'bg-orange-100', icon: <Home className="w-4 h-4" /> },
  ISETS_TRAINING_EMPLOYMENT: { label: 'Employment & Training', color: 'text-teal-700', bgColor: 'bg-teal-100', icon: <Users className="w-4 h-4" /> },
  TCN_RECREATION: { label: 'Recreation', color: 'text-pink-700', bgColor: 'bg-pink-100', icon: <Calendar className="w-4 h-4" /> },
  SOCIAL_WELFARE: { label: 'Social Welfare', color: 'text-red-700', bgColor: 'bg-red-100', icon: <Users className="w-4 h-4" /> },
  TREATY_LAND_ENTITLEMENT: { label: 'Treaty & Land', color: 'text-amber-700', bgColor: 'bg-amber-100', icon: <ClipboardCheck className="w-4 h-4" /> },
  TCN_PREVENTION: { label: 'Prevention', color: 'text-indigo-700', bgColor: 'bg-indigo-100', icon: <Calendar className="w-4 h-4" /> },
  JORDANS_PRINCIPLE: { label: "Jordan's Principle", color: 'text-yellow-700', bgColor: 'bg-yellow-100', icon: <Info className="w-4 h-4" /> },
  CSCMEC: { label: 'CSCMEC', color: 'text-cyan-700', bgColor: 'bg-cyan-100', icon: <FileText className="w-4 h-4" /> },
  HEADSTART: { label: 'Headstart', color: 'text-lime-700', bgColor: 'bg-lime-100', icon: <Users className="w-4 h-4" /> },
  PUBLIC_UTILITIES: { label: 'Public Utilities', color: 'text-slate-700', bgColor: 'bg-slate-100', icon: <Home className="w-4 h-4" /> },
  FINANCE: { label: 'Finance', color: 'text-emerald-700', bgColor: 'bg-emerald-100', icon: <FolderOpen className="w-4 h-4" /> },
  IT_COMMUNICATIONS: { label: 'IT & Communications', color: 'text-violet-700', bgColor: 'bg-violet-100', icon: <Info className="w-4 h-4" /> },
};
