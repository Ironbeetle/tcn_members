...
const updateFormSchema = z.object({
  ...
  category: z.enum(FORM_CATEGORIES).optional(),
...
export async function GET(
  ...
  try {
    ...
    // Map fields to expected format (parse options from JSON string to array)
...
export async function PUT(
  ...
  try {
    ...
    // Also update the portal's signup_form table (same enum values now)
    ...
    if (updateData.category !== undefined) portalUpdateData.category = updateData.category;
