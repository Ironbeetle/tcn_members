import { z } from "zod";
import { BULLETIN_CATEGORIES, FORM_CATEGORIES } from "@/lib/category-constants";
...
const bulletinCategoryEnum = z.enum(BULLETIN_CATEGORIES);
const formCategoryEnum = z.enum(FORM_CATEGORIES);
...
export const bulletinCreateSchema = z.object({
  ...
  content: z.string()
    ...
    .optional()
    .nullable(),
  category: bulletinCategoryEnum.default("COMMUNITY_ADMIN"),
});
...
export const bulletinQuerySchema = z.object({
  id: idSchema.optional(),
  category: bulletinCategoryEnum.optional(),
...
export const fillableFormCreateSchema = z.object({
  ...
  description: z.string()
    ...
    .optional(),
  category: formCategoryEnum.default("BAND_OFFICE"),
